            ...
            public void run() {
                try {
                    ...
                    if (mWrapSocket == null) {
                        ...
                        HappyDataInputStream stream = new HappyDataInputStream(mWrapSocket.getInputStream());
                    ...
                    Logs.d(TAG, "WebSocket EOF!", ex);
                    mListener.onDisconnect(0, "EOF");

                } catch (SSLException ex) {
                    // Connection reset by peer
                    Logs.d(TAG, "Websocket SSL error!", ex);
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Logs.d(TAG, "Error while disconnecting", ex);
                        mListener.onError(ex);
                    }
                }
            });
